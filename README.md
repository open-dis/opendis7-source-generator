...
This project generates a preliminary type-safe Java implementation of the DIS Protocol version 7, 
IEEE Standard 1278.1-2012 from SISO and IEEE specifications.  Protocol development unit (PDU)
data structures are defined using XML to facilitate creation of source code in multiple programming languages.
...
associated enumerations that are then carefully integrated and fully tested by the
