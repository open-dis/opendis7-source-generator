...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
    ...
    <xsl:template match="/"> <!-- process root of input document -->
        ...
        <xsl:variable name="javadocPdusUrl">
            <xsl:text>https://savage.nps.edu/opendis7-java/javadoc/edu/nps/moves/dis7/pdus/</xsl:text>
        </xsl:variable>
        <xsl:variable name="schemadocPdusUrl">
            <xsl:text>https://savage.nps.edu/opendis7-java/xml/SchemaDocumentation/DIS_7_2012.autogenerated_</xsl:text>
        </xsl:variable>
