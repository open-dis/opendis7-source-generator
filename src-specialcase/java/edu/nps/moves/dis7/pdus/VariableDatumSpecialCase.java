 ...
 */
public class VariableDatumSpecialCase extends Object implements Serializable
{
  /**
  ...
  /**
   * Setter for {@link VariableDatumSpecialCase#variableDatumID}
   *
   * @param pVariableDatumID of interest
   * @return same object to permit progressive setters
   */
  public VariableDatumSpecialCase setVariableDatumID(VariableRecordType pVariableDatumID)
  {
  ...
  /**
   * Getter for {@link VariableDatumSpecialCase#variableDatumID}
   *
  ...
  /**
   * Setter for {@link VariableDatumSpecialCase#variableDatumLength}
   * <p>
   * This value is the size IN BITS of the {@link VariableDatumSpecialCase#variableDatumValue} field. Since that field
   * is a byte array, its size must be large enough to contain the specified number of bits. If
   * {@link VariableDatumSpecialCase#variableDatumValue} is NOT
   ...
   * @return same object to permit progressive setters
   */
  public VariableDatumSpecialCase setVariableDatumLengthInBits(int bitLength)
  {
 ...
 /**
   * Setter for {@link VariableDatumSpecialCase#variableDatumLength}
   * <p>
   * This value is the size in bytes of the {@link VariableDatumSpecialCase#variableDatumValue} field. Since that field
   ...
   * @return same object to permit progressive setters
   */
  public VariableDatumSpecialCase setVariableDatumLengthInBytes(int byteLength)
  {
  ...
  /**
   * Getter for {@link VariableDatumSpecialCase#variableDatumLength}
   * @return length
   */
  ...
  /**
   * Setter for {@link VariableDatumSpecialCase#variableDatumValue}
   * <p>
   * This is described in the specification as a stream of bits, but is implemented in Java as a byte array.
   * The size of the byte array reflects the value of {@link VariableDatumSpecialCase#variableDatumLength} rounded to the next
   * highest byte boundary. If {@link VariableDatumSpecialCase#variableDatumLength} is not set when the Pdu is sent, the
   * receiver will read a bit length equal to the size of the byte array times 8.
   * @param pVariableDatumValue of interest
   * @return same object to permit progressive setters
   */
  public VariableDatumSpecialCase setVariableDatumValue(byte[] pVariableDatumValue)
  {
  ...
  /**
   * Getter for {@link VariableDatumSpecialCase#variableDatumValue}
  ...
  * The equals method doesn't always work--mostly it works only on classes that consist only of primitives. Be careful.
  ...
  public boolean equalsImpl(Object obj)
  {
    ...
    if (!(obj instanceof VariableDatumSpecialCase))
      return false;

    final VariableDatumSpecialCase rhs = (VariableDatumSpecialCase) obj;
