...
//      FileUtils.cleanDirectory(outputDirectory); // do NOT clean directory, results can co-exist with other classes
        ...
        try {
            ...
            packageInfoBuilder.append(" * EntityTypeFactory is a utility class for ").append(sisoSpecificationTitleDate).append(" typed enumeration classes supporting <a href=\"https://github.com/open-dis/open-dis7-java\" target=\"open-dis7-java\">open-dis7-java</a> library.\n");
            packageInfoBuilder.append("\n");
    ...
    private void saveEntityFile(TypeClassData data, String uid)
    {
        ...
        if (!packageInfoFile.exists()) // write package-info.java during first time through
        {
            ...
            try {
                ...
                packageInfoBuilder = new StringBuilder();
                packageInfoBuilder.append("/**\n");
                packageInfoBuilder.append(" * World entities using type classes for ").append(sisoSpecificationTitleDate).append(" enumerations supporting the <a href=\"https://github.com/open-dis/open-dis7-java\" target=\"open-dis7-java\">open-dis7-java</a> library.\n");
                packageInfoBuilder.append("\n");
                packageInfoBuilder.append(" * <p> Online: NPS <a href=\"https://gitlab.nps.edu/Savage/NetworkedGraphicsMV3500/-/tree/master/examples/src/OpenDis7Examples\" target=\"MV3500\">MV3500 Networked Simulation course examples</a> \n");
                packageInfoBuilder.append(" * which include links to <a href=\"https://gitlab.nps.edu/Savage/NetworkedGraphicsMV3500/-/tree/master/specifications/README.md\" target=\"README.MV3500\">IEEE and SISO specification references</a> of interest. </p>\n");
                packageInfoBuilder.append(" * <ul>\n");
