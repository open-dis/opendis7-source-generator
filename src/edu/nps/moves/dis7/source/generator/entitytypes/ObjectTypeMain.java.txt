...
public class ObjectTypeMain
{
    ...
    private void writeFile(CategoryElem cat) throws Exception
    {
        ...
        String contents = String.format(classTemplate, pkg, legalJavaDoc(cat.description), classNm, classNm, "Category", "Category", specEnum);
    ...
    private void writeFile(SubCategoryElem extra) throws Exception
    {
        ...
        String contents = String.format(classTemplate, pkg, legalJavaDoc(extra.description), classNm, classNm, "Subcategory", "SubCategory", specEnum);
        File f = saveFile(dir, classNm + ".java", contents);
        //System.out.println("Wrote "+f.getPath());
    }
