...
public class Main
{
    ...
    private void writeFile(CategoryElem cat) throws Exception
    {
        ...
        String contents = String.format(entityClassTemplate, pkg, legalJavaDoc(cat.description), classNm, classNm, "Category", "Category", specEnum);
    ...
    private void writeFile(SubCategoryElem subc) throws Exception
    {
        ...
        String contents = String.format(entityClassTemplate, pkg, legalJavaDoc(subc.description), classNm, classNm, "SubCategory", "SubCategory", specEnum);
        saveFile(dir, classNm + ".java", contents);
    }
    ...
    private void writeFile(SpecificElem spec) throws Exception
    {
        ...
        String contents = String.format(entityClassTemplate, pkg, legalJavaDoc(spec.description), classNm, classNm, "Specific", "Specific", specEnum);
        saveFile(dir, classNm + ".java", contents);
    }
    ...
    private void writeFile(ExtraElem extra) throws Exception
    {
        ...
        String contents = String.format(entityClassTemplate, pkg, legalJavaDoc(extra.description), classNm, classNm, "Extra", "Extra", specEnum);
        saveFile(dir, classNm + ".java", contents);
    }
